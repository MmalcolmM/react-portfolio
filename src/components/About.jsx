...
const About = () => {
  return (
    <div id="about">
      ...
      <div id="about-text">
        <figcaption>
          Hello! I'm Malcolm Franklin, a dedicated and driven full-stack web developer currently enrolled in the University of Denver's intensive bootcamp, with an anticipated graduation date of August 13th. Through this rigorous program, I have honed a diverse skill set that spans both front-end and back-end development, making me a versatile asset in the tech industry. <br />
